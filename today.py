...
def recursive_loc(owner, repo_name, data, cache_comment, addition_total=0, deletion_total=0, my_commits=0, cursor=None):
    ...
    query = '''
    query ($repo_name: String!, $owner: String!, $cursor: String, $id: ID) {
    ...
    variables = {'repo_name': repo_name, 'owner': owner, 'cursor': cursor, 'id': OWNER_ID['id']}
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2005, 4, 30))
    ...
    # Removed archive logic since it's specific to Andrew Grant
