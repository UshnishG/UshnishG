...
let content = `
  <g transform="translate(100, 20)">
    ...
    <text class="mono" x="300" y="20" fill="${COLORS.textMuted}" font-size="12" text-anchor="middle">ushnish@ai-core: ~</text>
    
    <g class="mono term-text" transform="translate(20, 60)">
      <text class="cmd1"><tspan class="prompt">ushnish@ai-core:~$</tspan> whoami</text>
      <text class="res1" y="25" fill="${COLORS.secondary}">Ushnish Ghosal - AI Engineer & Researcher</text>
      ...
      <text class="res3" y="135" fill="${COLORS.textMuted}">"Building scalable, intelligent systems for the future."</text>
      
      <text class="cmd4" y="165"><tspan class="prompt">ushnish@ai-core:~$</tspan> <tspan class="cursor" fill="${COLORS.textMain}">█</tspan></text>
    </g>
  </g>
`;

const svg = wrapSVG(content, width, height, customStyles);
writeSVG('assets/animations/terminal.svg', svg);
