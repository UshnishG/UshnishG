  ...
  content += `
    <g class="card" transform="translate(0, 0)">
      ...
      <foreignObject x="${x + 20}" y="${y + 60}" width="340" height="60">
        <div xmlns="http://www.w3.org/1999/xhtml" style="color: ${COLORS.textMuted}; font-size: 14px; font-family: 'Inter', sans-serif;">
          ${proj.desc}
        </div>
      </foreignObject>
      ${tags}
...
writeSVG('assets/animations/projects.svg', svg);
